...
--configs-path CONFIGS_PATH                Specify config directories path
--output-path OUTPUT_PATH                  Specify output path for generated files
--gen-headers [LANG ...]                   Generate/Configure header files. Options are:
                                             python
                                             c
                                             strip-verilog
                                             new-python
                                             ...
                                             verilog-muxes
                                             verilog-regs
                                             use-verilog-module-names
                                             verilog-files-per-module
...
--save-all-registers-html [{dark,light}]   Saves all registers to a cpu_registers.html file
--save-user-registers-html [{dark,light}]  Saves user registers to a cpu_registers.html file
```
## --build
